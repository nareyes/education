...
CREATE OR REPLACE STAGE MANAGE_DB.EXTERNAL_STAGES.AWS_STAGE_VALIDATE
    URL = 's3://snowflakebucket-copyoption/size/';

LIST @MANAGE_DB.EXTERNAL_STAGES.AWS_STAGE_VALIDATE;
...
COPY INTO DEMO_DB.PUBLIC.ORDERS_VALIDATE
    FROM @MANAGE_DB.EXTERNAL_STAGES.AWS_STAGE_VALIDATE

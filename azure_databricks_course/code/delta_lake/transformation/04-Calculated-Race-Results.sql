...
create table formula1_curated_delta.calculated_race_results
using delta
as
  ...
  from formula1_processed_delta.results_delta as r
    inner join formula1_processed_delta.drivers_delta as d
      on r.driver_id = d.driver_id
    inner join formula1_processed_delta.constructors_delta as c
      on r.constructor_id = c.constructor_id
    inner join formula1_processed_delta.races_delta as ra
...
-- Query Curated Table
select * from formula1_curated_delta.calculated_race_results;
...
from formula1_curated_delta.calculated_race_results
